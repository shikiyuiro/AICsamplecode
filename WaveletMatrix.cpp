...
public:
    ...
    i64 range_successor(i64 L, i64 R, i64 value){ i64 C = internal_range_freq(L, R, value + 1); return C == R - L ? -1 : internal_range_Kthmin_assignXOR(L, R, C, 0);}
    i64 range_predecessor(i64 L, i64 R, i64 value){ i64 C = internal_range_freq(L, R, value); return C == 0 ? -1 : internal_range_Kthmin_assignXOR(L, R, C - 1, 0);}
    i64 range_min_assignXOR(i64 L, i64 R, i64 value){ return internal_range_Kthmin_assignXOR(L, R, 0, value);}
    i64 range_max_assignXOR(i64 L, i64 R, i64 value){ return internal_range_Kthmin_assignXOR(L, R, R - L - 1, value);}
    i64 range_Kthmin_assignXOR(i64 L, i64 R, i64 K, i64 value){ return internal_range_Kthmin_assignXOR(L, R, K, value);}
    i64 range_Kthmax_assignXOR(i64 L, i64 R, i64 K, i64 value){ return internal_range_Kthmin_assignXOR(L, R, R - L - K - 1, value);}
private:
    vector<i64> Matrix;
    i64 bitsize;
    i64 prefixsize;
    ...
    i64 internal_range_Kthmin_assignXOR(i64 L, i64 R, i64 K, i64 value){
        i64 res = 0;
        for(i64 h = bitsize - 1; h >= 0; h--){
            auto [L0, R0, L1, R1] = decomp(L, R, h);
            if(value & ((i64)1 << h)){
